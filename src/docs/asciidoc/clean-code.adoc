...
* *Clean Code* [Robert C. Martin & others; Prentice Hall ISBN: 978-0-13-235088-4]
* *Refactoring* [Martin Fowler; Addison Wesley ISBN: 978-0-201-48567-7]
* *Head First Design Patterns* [Eric Freeman, Elisabeth Freeman, Kathy Sierra, and Bert Bates; O’Reilly ISBN: 978-0-596-00712-6
* *Refactoring to Patterns* [Joshua Kerievsky; Addison Wesley ISBN: 0-321-21335-1
* *Emergent Design* [Scott L. Bain; Addison Wesley ISBN: 0-321-50936-6]